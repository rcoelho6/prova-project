...
@XmlRootElement(name = "retreiveByClient", namespace = "http://service.project.prova/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "retreiveByClient", namespace = "http://service.project.prova/")

public class RetreiveByClient {
